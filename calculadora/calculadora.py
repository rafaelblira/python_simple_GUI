...
bw: dict = {'size':(7,2), 'font':('Arial', 24), 'button_color':("black","#F8F8F8")}
bt: dict = {'size':(7,2), 'font':('Arial', 24), 'button_color':("black","#F1EABC")}
...
window: object = sg.Window('Calculadora 1.0', layout=layout, background_color="#272533", size=(580, 660), return_keyboard_events=True)
